...
public class activityEditEvents extends AppCompatActivity {

    private DatabaseReference mUsersRef;

    TextView title, mUpdate;
    Toolbar mToolbar;
    String mID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUpdate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(activityEditEvents.this, "Please Complete Information with all fields", Toast.LENGTH_SHORT).show();
                }
    ...
    private void checkTitle(final String eTitle)
    {
        ...
        mUsersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    Toast.makeText(activityEditEvents.this, "Title already exists", Toast.LENGTH_SHORT).show();
                }
    ...
    private void updateEvent()
    {
        ...
        Toast.makeText(activityEditEvents.this, "Event updated successfully! ", Toast.LENGTH_SHORT).show();
        finish();
    }
